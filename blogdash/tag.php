...
if(isset($_GET['tagdel']))
     {
       $del=$_GET['tagdel'];

       $sql="delete from tag where tag_id='$del'";
...
<body>
  ...
  <div class="content">
    ...
    <div class="main container">
      <div class="text-center"><h3>Tag</h3></div>
            ...
            <div class="modal-body">
                  <form class="" action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="formGroupExampleInput" placeholder="Enter Tag Name">
                    </div>
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th scope="col" style="display:none;">Tag id</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="display:none;"><?php echo $row['tag_id']; ?></td>
                <td><?php echo $row['tag_name']; ?></td>
             
               
                <td class="d-flex"><a href="javascript:;" data-toggle="modal" data-target="#exampleModal<?php echo $row['tag_id']; ?>" class="btn btn-primary btn1">Edit</a><a href="tag.php?tagdel=<?php echo $row['tag_id'];?>" class="btn btn-danger btn1 ml-2">Delete</a></td>
              </tr>

              <div class="modal fade" id="exampleModal<?php echo $row['tag_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                          ...
                          <form class="" action="action.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $row['tag_id']; ?>">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" value="<?php echo $row['tag_name']; ?>" name="updatetagname" id="formGroupExampleInput" >
                              </div>
                              <input type="submit" value="Update" class="btn " name="tagupdate">
                            </form>
                    </div>
                    <!-- <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
