...
<head>
    ...
    <!--<meta charset="utf-8">
    <title>Join us | Pyx Photography</title>
    <link rel="icon" href="images/favicon.svg" type="image/gif" sizes="16x16">
    <meta name="description"
        content="Apply here to become a Pyx affiliated photographer. Open up a world of possibilities taking personal and business shoots across India.">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="file" id="formFile" required="" name="adharcard" accept="image/*, application/pdf" onchange=" fileValidation()">
                                </div>
                  ...
                  <label for="No" style="font-size:18px;">No</label><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" style="height: 100px" name='expdesc'
                                        required></textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input maxlength="2" type="text" class="form-control"
                                        placeholder="Numbers of hours/ week" name="workhour"
                                        onkeypress="return isNumberKey(event)" required>
                                </div>
                            ...
                            <div class="panel-body">
                                <div class="container m-auto" style="padding: 0px;">
                                    ...
                                    <div class="my-custom-scrollbar" id="list"
                                        style="padding:0px 21px 0px 20px;background-color: #fff;">
                                        <?php
